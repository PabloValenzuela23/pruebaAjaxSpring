...
import com.example.demo.services.PisoService;
...
public class MainController {
	...
	{	
	 ...
	 public String index(ModelMap modelMap){
		 modelMap.put("sedes", sedeService.findAll());
		 return "demo/index";
	 }
	 
	 
	 @ResponseBody
	 @RequestMapping(value = "loadPisoByCountry/{id}",method = RequestMethod.GET)
	 public String loadPisoByCountry(@PathVariable("id")int id) {
		 Gson gson = new Gson();
		 return gson.toJson(pisoService.findBySede(id));
	 }
